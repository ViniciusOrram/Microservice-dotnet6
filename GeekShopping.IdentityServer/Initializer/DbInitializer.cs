    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                Email = "vinicius-admin@qlqc.com.br",
                EmailConfirmed = true,
            ...
            _user.CreateAsync(admin, "Vinicius123$").GetAwaiter().GetResult();
            ...
            ApplicationUser client = new ApplicationUser()
            {
                ...
                Email = "vinicius-client@qlqc.com.br",
                EmailConfirmed = true,
                PhoneNumber = "+55 (11) 12345-6789",
                FirstName = "Vinicius",
                LastName = "Client"
            ...
            _user.CreateAsync(client, "Vinicius123$").GetAwaiter().GetResult();
